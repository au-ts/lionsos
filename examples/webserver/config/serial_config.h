...
#define SERIAL_TX_DATA_REGION_CAPACITY_CLI0            SERIAL_DATA_REGIO_CAPACITYN
#define SERIAL_TX_DATA_REGION_CAPACITY_CLI1            SERIAL_DATA_REGIO_CAPACITYN
...
_Static_assert(SERIAL_MAX_TX_DATA_CAPACITY < UINT32_MAX,
