...
def generate_topology_dot(*, interfaces, router, webserver, icmp_module,
                          all_connections, all_regions, all_net_edges) -> str:
    """Generate a graphviz DOT string from connection/region specs and net edges."""
    ...
    # Connection edges
    for name, spec in all_connections.items():
