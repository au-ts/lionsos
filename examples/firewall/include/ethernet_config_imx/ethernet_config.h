...
#define NET_CLI0_NAME "eth1_virt_tx"
#define NET_COPY0_NAME "eth0_forwarder"
#define NET_VIRT_RX_NAME "eth0_virt_rx"
#define NET_VIRT_TX_NAME "eth0_virt_tx"
#define NET_DRIVER_NAME "eth0"
