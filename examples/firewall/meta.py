...
def generate(sdf_file: str, output_dir: str, dtb: DeviceTree):
    ...
    routing1 = ProtectionDomain("routing1", "routing_external.elf", priority=97, budget=20000)
    ...
    routing2 = ProtectionDomain("routing2", "routing_internal.elf", priority=94, budget=20000)
    ...
    micropython = ProtectionDomain("micropython", "micropython.elf", priority=50, budget=20000)

    firewall = LionsOs.Firewall(sdf, net_system, net_system2, routing1, routing2, arp_responder1, arp_responder2, arp_requester1, arp_requester2, micropython)
    ...
    udp_filter2 = ProtectionDomain("udp_filter2", "udp_filter2.elf", priority=91, budget=20000)

    tcp_filter = ProtectionDomain("tcp_filter", "tcp_filter.elf", priority=92, budget=20000)
    tcp_filter2 = ProtectionDomain("tcp_filter2", "tcp_filter2.elf", priority=92, budget=20000)
    ...
    timer_system.add_client(arp_requester2)
    timer_system.add_client(micropython)

    net_system2.add_client(micropython)
    ...
    firewall.add_filter(udp_filter2, 0x11, 2)
    firewall.add_filter(tcp_filter2, 0x06, 2)
