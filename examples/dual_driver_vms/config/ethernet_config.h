...
#define NET_DRIVER_NAME "VMM1"

#define NET_DATA_REGION_CAPACITY                   0x200000
#define NET_HW_REGION_CAPACITY                     0x10000
...
#define NET_RX_QUEUE_SIZE_CLI1 NET_RX_QUEUE_CAPACITY_CLI0 // bit of a hack cause its hardcoded in upy
...
#define ETH_MAX_QUEUE_SIZE MAX(NET_TX_QUEUE_SIZE_DRIV, \
                               MAX(NET_RX_QUEUE_SIZE_DRIV, NET_RX_QUEUE_SIZE_CLI0))
_Static_assert(NET_TX_QUEUE_CAPACITY_DRIV >=
               NET_TX_QUEUE_CAPACITY_CLI0,
