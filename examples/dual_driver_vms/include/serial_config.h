...
#define SERIAL_CLI0_NAME "VMM1"
#define SERIAL_CLI1_NAME "VMM2"
...
// @billn: unsure why doesnt compile without these two, git troubles?
#define SERIAL_TX_DATA_REGION_CAPACITY_DRIV SERIAL_TX_DATA_REGION_SIZE_DRIV
#define SERIAL_RX_DATA_REGION_CAPACITY_DRIV SERIAL_RX_DATA_REGION_SIZE_DRIV
