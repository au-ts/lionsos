...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    # Test components
    test_core = ProtectionDomain("test_core", "test_core.elf", priority=1, stack_size=0x10000)
    test_file = ProtectionDomain("test_file", "test_file.elf", priority=1, stack_size=0x10000)
    test_server = ProtectionDomain("test_server", "test_server.elf", priority=2, stack_size=0x10000)
    test_client = ProtectionDomain("test_client", "test_client.elf", priority=1, stack_size=0x10000)
    ...
    test_server_copier = ProtectionDomain("test_server_copier", "network_copy_test_server.elf", priority=97, budget=20000)
    test_client_copier = ProtectionDomain("test_client_copier", "network_copy_test_client.elf", priority=97, budget=20000)

    # Connect test_core (no network, no FS)
