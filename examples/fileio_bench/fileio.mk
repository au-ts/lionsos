...
$(SYSTEM_FILE): $(METAPROGRAM) $(IMAGES) $(DTB)
	...
	$(OBJCOPY) --update-section .timer_client_config=timer_client_fs_client.data fs_client.elf
	$(OBJCOPY) --update-section .serial_client_config=serial_client_fs_client.data fs_client.elf
	$(OBJCOPY) --update-section .fs_client_config=fs_client_fs_client.data fs_client.elf
