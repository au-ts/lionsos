...
#define NET_TX_DATA_REGION_CAPACITY_CLI0            NET_DATA_REGION_SIZE
...
#define NET_RX_DATA_REGION_CAPACITY_DRIV            NET_DATA_REGION_SIZE
#define NET_RX_DATA_REGION_CAPACITY_CLI0            NET_DATA_REGION_SIZE
...
#define ETH_MAX_QUEUE_SIZE MAX(NET_TX_QUEUE_CAPACITY_DRIV, \
