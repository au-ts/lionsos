...
static inline void rrer_perform_reschedule()
{
    for (rr_Child_t **child = rr_sched_iterate(NULL); child != NULL; child = rr_sched_iterate(child)) {
        switch (child[0]->sched_state) {
