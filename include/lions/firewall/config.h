...
typedef struct firewall_webserver_config {
    ...
    firewall_connection_resource_t rx_free;
    firewall_connection_resource_t arp_queue;
    firewall_webserver_interface_config_t interfaces[FIREWALL_NUM_INTERFACES];
