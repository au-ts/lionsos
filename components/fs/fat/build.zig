...
pub fn build(b: *std.Build) void {
    ...
    fs.addCSourceFile(.{ .file = b.path("fatfs_event.c"), .flags = &.{ "-mstrict-align", "-fno-sanitize=undefined" } });
    fs.addCSourceFile(.{ .file = b.path("fatfs_op.c"), .flags = &.{ "-mstrict-align", "-fno-sanitize=undefined" } });
    fs.addCSourceFile(.{ .file = b.path("fs_diskio.c"), .flags = &.{ "-mstrict-align", "-fno-sanitize=undefined" } });
    fs.addCSourceFile(.{ .file = b.path("co_helper.c"), .flags = &.{ "-mstrict-align", "-fno-sanitize=undefined" } });
    fs.addCSourceFile(.{
        .file = b.path("ff15/source/ff.c"),
        .flags = &.{ "-mstrict-align", "-nostdlib", "-fno-sanitize=undefined" },
    });
    fs.addCSourceFile(.{ .file = b.path("ff15/source/ffunicode.c"), .flags = &.{ "-mstrict-align", "-fno-sanitize=undefined" } });

    fs.addCSourceFile(.{ .file = b.path("../../../dep/sddf/util/printf.c"), .flags = &.{ "-mstrict-align", "-fno-sanitize=undefined" } });
    fs.addCSourceFile(.{ .file = b.path("../../../dep/sddf/util/putchar_debug.c"), .flags = &.{ "-mstrict-align", "-fno-sanitize=undefined" } });
