...
int mp_hal_stdin_rx_chr(void) {
    ...
    while(serial_queue_empty(&serial_rx_queue, local_head)) {
    ...
    // }
    char c;
    serial_dequeue(&serial_rx_queue, &serial_rx_queue.queue->head, &c);
    local_head = &serial_rx_queue.queue->head;
    return c;
}
