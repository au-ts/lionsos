...
micropython.elf: FORCE mpy-cross ${LIONSOS}/dep/libmicrokitco/libmicrokitco.mk $(MICROPYTHON_FROZEN_MANIFEST) $(MICROPYTHON_EXEC_MODULE) lib_sddf_lwip_mp.a
	$(MAKE) -C $(MICROPYTHON_DIR) \
		...
		LIBC=$(MICROPYTHON_LIBC) \
		LIBMATH=$(MICROPYTHON_LIBMATH) \
		LIBGCC=$(MICROPYTHON_LIBGCC) \
		BUILD=$(abspath .) \
