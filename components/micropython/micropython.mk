...
micropython.elf: FORCE mpy-cross ${LIONSOS}/dep/libmicrokitco/Makefile $(MICROPYTHON_FROZEN_MANIFEST) $(MICROPYTHON_EXEC_MODULE) ${MUSL}/lib/libc.a
	$(MAKE) -C $(MICROPYTHON_DIR) \
		...
		ENABLE_I2C=$(MICROPYTHON_ENABLE_I2C) \
